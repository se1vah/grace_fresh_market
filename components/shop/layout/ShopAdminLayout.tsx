...
import { ShopNotificationProvider } from '@/components/shop/notifications/ShopNotificationManager';
import { ShopOrdersProvider } from '@/components/shop/orders/ShopOrdersContext';
